...
public class SlotTypeDependentSpacingStrategyTest {
    ...
    public void testNoOverlappingSlots() {
        ...
        Map<String, Map<String, Long>> margins = new HashMap<>();
        Map<String, Long> type1_type2_margin = new HashMap<>();
        type1_type2_margin.put(TYPE_2, 1000l);
    ...
    public void tesBadConfiguration() {
        ...
        Map<String, Map<String, Long>> margins = new HashMap<>();
        Map<String, Long> type1_type2_margin = new HashMap<>();
        type1_type2_margin.put("BAD_TYPE", 1000l);
        margins.put(TYPE_1, type1_type2_margin);
        SlotTypeDependentSpacingStrategy strategy = new SlotTypeDependentSpacingStrategy(margins);
    ...
    @Test
    @DisplayName("Slot type dependent spacing strategy - slot spacing value")
    public void testGetSlotSpacing() {
        ...
        margins.put(TYPE_1, type1_type2_margin);
        SlotTypeDependentSpacingStrategy strategy = new SlotTypeDependentSpacingStrategy(margins);
        assertEquals(1000, strategy.getSlotSpacing(slot1, slot2));
    }
}
